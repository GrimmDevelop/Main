...
@section('body')
    <div class="row">
        <div class="col-md-12">
            ...
            @if(isset($result))
            Es wurden {{ $count }} Briefe gefunden. <span class="glyphicon glyphicon-question-sign" data-toggle="tooltip" title="Es werden maximal 100 Suchergebnisse angezeigt!"></span><br /><br />
            <table class="table">
