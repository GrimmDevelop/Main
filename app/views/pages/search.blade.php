...
@endif
            ...
            <div class="result" ng-show="results.total > 0">
                ...
                <div ng-repeat="letter in results.data" class="row">
                    <div class="col-md-2"><a href letter-preview="letter">@{{ letter.id }}</a></div>
                    <div class="col-md-8">
                        <table class="table">
                            <thead>
                                <tr>
                    ...
                    <div class="col-md-1">
                        <a href location-preview="letter.from_id" class="btn btn-default" ng-show="letter.from_id">
                             <span class="glyphicon glyphicon-map-marker"></span>
                             <span class="glyphicon glyphicon-arrow-right"></span>
                             <span class="glyphicon glyphicon-envelope"></span>
                        </a>
                        <a href person-preview="person.id" ng-repeat="person in letter.senders" class="btn btn-default">
                    ...
                    <div class="col-md-1">
                        <a href location-preview="letter.to_id" class="btn btn-default" ng-show="letter.to_id">
                            <span class="glyphicon glyphicon-envelope"></span>
                            <span class="glyphicon glyphicon-arrow-right"></span>
                            <span class="glyphicon glyphicon-map-marker"></span>
                        </a>
                        <a href person-preview="person.id" ng-repeat="person in letter.receivers" class="btn btn-default">
                            <span class="glyphicon glyphicon-envelope"></span>
                            <span class="glyphicon glyphicon-arrow-right"></span>
                            <span class="glyphicon glyphicon-user"></span>
                        </a>
